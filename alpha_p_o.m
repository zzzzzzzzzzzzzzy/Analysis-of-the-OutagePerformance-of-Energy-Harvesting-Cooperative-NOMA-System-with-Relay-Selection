...
grid on 
hold on
correct([0.955,0.96625,0.9775,0.98875],{'10^-^1','10^-^0^.^7^5','10^-^0^.^5','10^-^0^.^2^5'});


legend('F1 alpha=0.1','F2 alpha=0.1','F1 alpha=0.2','F2 alpha=0.2','F1 alpha=0.3','F2 alpha=0.3');
